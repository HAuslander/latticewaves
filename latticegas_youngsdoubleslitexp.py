...
def  ProcessFile():
  ...
  NDIM = 101 # must be at least 10 or 20
  history_xval = 0  # this is used to track 1 specific particle
  
  NScenarios = 1 # 64  # we get smoother distributions if se generate several different gases and average the amplitube over them, but feel free to set it to 1
  halfband = 3
